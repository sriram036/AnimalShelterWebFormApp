...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="display: flex; justify-content: center; justify-items: center; align-content: center; align-items: center; font-family: 'Times New Roman'; font-weight: bold; background-color: #FFFFCC; border-radius: 20px;">
        <!--margin-left: 400px;margin-top:75px;-->
        <div>
            <table class="auto-style1" id="form">
                <tr style="background-color: yellowgreen">
                    <td colspan="2" style="font-family: Arial, Helvetica, sans-serif; font-size: x-large; font-weight: bold; color: #800000; border-radius:7px; text-align: center">Animal Shelter Management System</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:TextBox ID="TextBox2" runat="server" Font-Size="Medium" Width="200px" BorderColor="#0099CC" BorderStyle="Solid"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList1" runat="server" Width="200px">
                            <asp:ListItem>SeletctType</asp:ListItem>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox3" runat="server" Font-Size="Medium" Width="200px" BorderColor="#0099CC" BorderStyle="Solid"></asp:TextBox>&nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox6" runat="server" Height="75px" Width="200px" BorderColor="#0099CC" BorderStyle="Solid"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td>
                        <asp:Button ID="Button1" runat="server" BackColor="#3399FF" Font-Size="Large" ForeColor="White" OnClick="Button1_Click" Text="Submit" Width="100px" BorderColor="#3399FF" BorderStyle="Solid" BorderWidth="7px" />
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="Button6" runat="server" BackColor="#3399FF" Font-Size="Large" ForeColor="White" OnClick="Button4_Click" Text="Clear" Width="100px" BorderColor="#3399FF" BorderStyle="Solid" BorderWidth="7px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
